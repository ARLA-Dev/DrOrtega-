...
public class HISTORIAS extends JTextArea implements TableCellRenderer
{
    public HISTORIAS()
    {
        setLineWrap(true);
        setWrapStyleWord(true);
        setFont(new java.awt.Font("Leelawadee", 0, 12));
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column)
    {
        ...
        int preferredHeight = getPreferredSize().height + 200;
    ...
    public static void createAndShowGUI()
    {
        ...
        table.getColumnModel().getColumn(1).setCellRenderer(new HISTORIAS() );
